...
def setUpCovidDataTable(cur, conn):
    #uncomment drop if exists if you want to start again with an empty table
    #cur.execute("DROP TABLE IF EXISTS CovidData")
    #make headers
...
def setUpCountryOpenAQTable(cur, conn):
    #uncomment drop if exists if you want to start again with an empty table
    #cur.execute("DROP TABLE IF EXISTS AirDataCountries")
    #make headers
...
def setUpAQParameterTable(cur, conn):
    #uncomment drop if exists if you want to start again with an empty table
    #cur.execute("DROP TABLE IF EXISTS AQParameter")
    #make headers
...
def setUpCountryTable(cur, conn):
    #uncomment drop if exists if you want to start again with an empty table
    #cur.execute("DROP TABLE IF EXISTS CountryData")
    #make headers
...
def csv_to_json_converter(csvfile, jsonfile):
    ...
    try:
        ...
        full_path = os.path.join(dir, jsonfile)
